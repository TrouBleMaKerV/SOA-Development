...
public class ScoreServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        List<Score> scores = scoreDao.getScore(sid);
        try {
            ...
            if (scores.size()>0) {
                ...
                for (Score score: scores) {
                    ...
                    courseElement.addAttribute(element.createQName("课程编号","jw"),
                            score.getCid()+"");
                    courseElement.addAttribute(element.createQName("课程名称","jw"),
                            score.getCname()+"");
                    ...
                    scoreElement.addChildElement(scoreElement.createQName("学号","jw"))
                            .addTextNode(score.getSid()+"");
                    scoreElement.addChildElement(scoreElement.createQName("得分","jw"))
                            .addTextNode(String.valueOf(score.getScore()));
                }
            } else {
